...
# Зачем же вообще делать обучение/онбординг пользователя в Яндекс Товарах?
...
Самые удачные варианты исполнения фичи разложил на доску референсов.
...
- После того как определился с макетами перешел бы делать микроанимации для ключевых переходов и состояний – чтобы сделать интерфейс приятнее и более живым. По типу анимации выбирал бы с разработкой что проще интегрировать и в дальнейшем поддерживать Lottie или Rive.
